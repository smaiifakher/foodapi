                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col-sm mb-2 mb-sm-0">
                                ...
                                @if (\App\CentralLogics\Helpers::get_restaurant_data()->self_delivery_system == 1)
                                    <div class="d-flex align-items-center mt-2 mb-2">
                                        <span class="h5 mb-0">
                                            <span class="legend-indicator bg-primary"
                                                style="background-color: #022b2b!important;"></span>
                                            {{translate('Delivery_Fee_Earning')}} : {{\App\CentralLogics\Helpers::format_currency(array_sum($delivery_earning))}}
                                        </span>
                                    </div>
                                @endif
                        ...
                        <div class="chartjs-custom">
                            ...
                            "data": {
                              ...
                              },
                              {
                               ...
                               @if(\App\CentralLogics\Helpers::get_restaurant_data()->self_delivery_system == 1)
                                ,{
                                    "data": [{{$delivery_earning[1]}},{{$delivery_earning[2]}},{{$delivery_earning[3]}},{{$delivery_earning[4]}},{{$delivery_earning[5]}},{{$delivery_earning[6]}},{{$delivery_earning[7]}},{{$delivery_earning[8]}},{{$delivery_earning[9]}},{{$delivery_earning[10]}},{{$delivery_earning[11]}},{{$delivery_earning[12]}}],
                                    "backgroundColor": "#022b2b",
                                    "borderColor": "#022b2b"
                                }
                              @endif
                              ]
