                ...
                <form action="{{route('admin.zone.store')}}" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">{{translate('Coordinates')}}<span class="input-label-secondary" title="{{translate('messages.draw_your_zone_on_the_map')}}">{{translate('messages.draw_your_zone_on_the_map')}}</span></label>
                                <textarea type="text" rows="8" name="coordinates"  id="coordinates" class="form-control" readonly></textarea>
                            </div>
                            <div class="row">
                                <!-- <label class="d-flex justify-content-between switch toggle-switch-sm text-dark col-12 border-bottom pb-1" for="zone_wise_delivery_fee">
                                    <span class="text-capitalize font-weight-bold">{{translate('messages.zone_wise_delivery_fee')}}</span>
                                    <input type="checkbox" class="toggle-switch-input" name="zone_wise_delivery_fee" id="zone_wise_delivery_fee" value="1" checked>
                                ...
                                <div class="col-6 shipping_input_group">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="minimum_shipping_charge" min="0" max="99999999.99" step="0.01" name="minimum_delivery_charge" class="form-control shipping_input">
                                    </div>                                    
                                </div>
                                ...
                                <div class="col-6 shipping_input_group">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="shipping_charge_per_km" min="0" max="99999999.99" step="0.01" name="per_km_delivery_charge" class="form-control shipping_input">
                                    </div>                                    
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="table-responsive datatable-custom">
                        <table id="columnSearchDatatable"
                            ...
                            <tr>
                                ...
                                <th >{{translate('messages.restaurants')}}</th>
