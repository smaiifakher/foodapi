        ...
        <div class="card px-3">
            <div class="row" style="border-radius: 10px">
                ...
                @php
                    ...
                    $admin_delivery_fee_commission=$order_transactions->sum('delivery_fee_comission');
                                ...
                                <div class="col">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h4 class="mb-1">{{__('messages.admin')}} {{__('messages.earned')}} <small
                                    style="color: red">
                                    <span class="input-label-secondary" title="{{ translate('messages.including_food_delivery_fee_commission') }}"><img src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"></span></small></h4>
                                            <span class="font-size-sm text-success">
                                                {{\App\CentralLogics\Helpers::format_currency($admin_earned + $admin_delivery_fee_commission)}} 
                                            </span>
                                        </div>
                                    </div>
                                    <!-- End Media -->
                    ...
                    <table id="datatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th  style="width: 10%">{{__('messages.total_order_amount')}}</th>
                                <th  style="width: 10%">{{__('messages.restaurant_commission')}}</th>
                                <th  style="width: 10%">{{__('messages.admin_commission')}}</th>
                                <th  style="width: 11%">{{__('messages.delivery')}} {{__('messages.fee')}}</th>
                                <th  style="width: 14%">{{translate('messages.commission_on_delivery_fee')}}</th>
                                <th  style="width: 8%">{{__('messages.vat/tax')}}</th>
                                <th  style="width: 10%">{{__('messages.amount')}} {{__('messages.received_by')}}</th>
                                <th  style="width: 15%">{{__('messages.created_at')}}</th>
                            </tr>
                        </thead>
                        <tbody>
